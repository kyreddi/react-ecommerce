...
const CustomCheckout = ({ shipping, cartItems, history: { push } }) => {
  ...
  useEffect(() => {
    ...
    if (shipping) {
      const body = {
        ...
        description: 'payment intent for YCART shop',
  ...
  return (
    <div>
      ...
      <div>
        <StripeCheckout
        stripekey="pk_test_51ImiItSEXAU1gzCCLYkgBsXRxQ0d1JtaPAzZPWVsQaRDtIGYtNKDFL732tD84AtJ2ROT8NSX8HN68Aixv4SROPj500moXm4H26"
        />
      </div>
